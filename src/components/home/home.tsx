    ...
    return (
      <div id="home" className="row">
        ...
        <div id="desc" className="col-md-12">
          Hi. I am a Full Stack Web Developer currently working at MAQ Software, Mumbai. I love
          building websites and designing user interfaces. I am currently focused on Full - Stack
          development using .NET and React/ Angular.
        </div>
